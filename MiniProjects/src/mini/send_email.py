...
# SMTP 계정 정보
username = 'test.seungeun@gmail.com'  # Gmail 계정
password = 'hakaituvzatfwnwl'  # Gmail 앱 비밀번호

# 메일 송/수신자 정보
from_addr = ('Google Test_Seungeun', 'test.seungeun@gmail.com')  # 보내는 사람 주소. (이름, 이메일)
to_addrs = [  # 받는 사람 주소. (이름, 이메일)
    ('Google Dev_Seungeun', 'dev.seungeun@gmail.com'),
    ('Naver bse14', 'bse14@naver.com')
]
...
if __name__ == '__main__':
    mail = SendMail(smtp_address, from_addr, to_addrs, debug=False)
